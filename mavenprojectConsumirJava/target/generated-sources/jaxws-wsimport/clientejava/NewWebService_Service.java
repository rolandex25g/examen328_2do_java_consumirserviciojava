 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://mipaquete/", wsdlLocation = "http://localhost:8080/WebApplication1Servicio/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://mipaquete/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebApplication1Servicio/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://mipaquete/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://mipaquete/", "NewWebServicePort"), NewWebService.class, features);
    }
